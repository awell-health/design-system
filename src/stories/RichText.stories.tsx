...
const formattingContent = JSON.stringify([
  ...
  {
    type: 'p',
    children: [{ text: 'The RichText component supports various text formatting:' }]
  },
  {
    type: 'ul',
    children: [
      ...
      {
        type: 'li',
        children: [{ text: 'Code: ', code: true }, { text: 'For displaying inline code snippets.' }]
      },
      {
        type: 'li',
        children: [
...
const headingsContent = JSON.stringify([
  ...
  {
    type: 'p',
    children: [{ text: 'Major section heading, typically used for main titles.' }]
  },
  {
    type: 'h2',
  ...
  {
    type: 'p',
    children: [{ text: 'Sub-section heading, used for dividing content into logical groups.' }]
  },
  {
    type: 'h3',
  ...
  {
    type: 'p',
    children: [{ text: 'Minor heading for smaller content divisions.' }]
  },
  {
    type: 'blockquote',
    children: [
...
const listsContent = JSON.stringify([
  {
    type: 'h2',
    children: [{ text: 'List Examples' }]
  },
  {
    type: 'p',
    children: [{ text: 'The component supports both ordered and unordered lists:' }]
  },
  {
    type: 'h3',
...
const mediaContent = JSON.stringify([
  ...
  {
    type: 'p',
    children: [{ text: 'Above is an example video.' }]
  },
  {
  ...
  {
    type: 'p',
    children: [{ text: 'Above is an example audio element.' }]
  },
  {
    type: FilePlugin.key,
...
const comprehensiveContent = JSON.stringify([
  {
    type: 'h1',
    children: [{ text: 'Rich Text Viewer Component' }]
  },
  {
    type: 'p',
    children: [
